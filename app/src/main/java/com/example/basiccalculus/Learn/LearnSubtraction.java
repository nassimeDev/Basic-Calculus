...
public class LearnSubtraction extends AppCompatActivity {
    Button simple, advanced, userLev, username;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn_subtraction);
        initialise();
    ...
    public void movement(String type){
        Intent i = null;
        if(type == "simple") {
            i = new Intent(this, SimpleSub.class);
        }
        if(type == "advanced") {
            i = new Intent(this, AdvancedSub.class);
        }
        startActivity(i);
    }
    void clickHandler()
