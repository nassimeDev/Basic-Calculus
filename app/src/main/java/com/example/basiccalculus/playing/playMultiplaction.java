...
public class playMultiplaction extends AppCompatActivity {
    Button lvl1, lvl2, lvl3, lvl4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_play_multiplaction);
    ...
    void initialise(){
        ...
        lvl2 = findViewById(R.id.lvl2);   lvl2.setEnabled(false);
        lvl3 = findViewById(R.id.lvl3);   lvl3.setEnabled(false);
        lvl4 = findViewById(R.id.lvl4);   lvl4.setEnabled(false);
        if(User.level >0)
