...
public class B4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            t.speak("four",TextToSpeech.QUEUE_FLUSH,null,null);
        });
            ...
            public void onInit(int status) {
                if(status == TextToSpeech.SUCCESS){
                    ...
                    if(result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED)
                        Toast.makeText(B4.this, "Try again", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(B4.this, "Try again", Toast.LENGTH_SHORT).show();
    ...
    void Verification()
    {
        ...
        {
            if(write4.getText().toString().isEmpty())
                Toast.makeText(this, "Please enter the number!", Toast.LENGTH_SHORT).show();
            else if(Integer.parseInt(String.valueOf(write4.getText())) == 4){
