...
public class B1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            t.speak("one",TextToSpeech.QUEUE_FLUSH,null,null);
        });
        Verification();
    }
    void initialise()
            ...
            public void onInit(int status) {
                if(status == TextToSpeech.SUCCESS){
                    ...
                    if(result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED)
                        Toast.makeText(B1.this, "Try again", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(B1.this, "Try again", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    void Verification()
    {
        ...
        {
            if(write1.getText().toString().isEmpty())
                Toast.makeText(this, "Please enter the number!", Toast.LENGTH_SHORT).show();
            else if(Integer.parseInt(String.valueOf(write1.getText())) == 1){
