...
public class B6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            t.speak("six",TextToSpeech.QUEUE_FLUSH,null,null);
        });
        Verification();
    }
    void initialise()
    {
        ...
        write6 = findViewById(R.id.write2);
            ...
            public void onInit(int status) {
                if(status == TextToSpeech.SUCCESS){
                    ...
                    if(result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED)
                        Toast.makeText(B6.this, "Try again", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(B6.this, "Try again", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    void Verification()
    {
        ...
        {
            if(write6.getText().toString().isEmpty())
                Toast.makeText(this, "Please enter the number!", Toast.LENGTH_SHORT).show();
            else if(Integer.parseInt(String.valueOf(write6.getText())) == 6){
